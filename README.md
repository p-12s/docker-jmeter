...
**Thanks to [Just van den Broecke](https://github.com/justb4) - 
I took his repository as a [basis](https://github.com/justb4/docker-jmeter)**

Docker image for [Apache JMeter](http://jmeter.apache.org).
This Docker image can be run as the ``jmeter`` command. 
Find Images of this repo on [Docker Hub](https://hub.docker.com/r/p12s/jmeter).
...
of the pre-built Images from [Docker Hub](https://hub.docker.com/r/p12s/jmeter).
...
1. In a Terminal/Command session, install Git, navigate/make a folder, then:
   ...
   ```
   git clone https://github.com/p-12s/docker-jmeter.git
   cd docker-jmeter
   ```
...
1. Run the Build script to download dependencies, including the docker CLI:
   ...
   <tt>Successfully tagged p-12s/jmeter:5.4.1</tt>
